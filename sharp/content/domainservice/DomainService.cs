...
(IVideoRepository videoRepo, IUserRepository userRepo, IVoteRepository voteRepo)
    : IDomainService {
  ...
  public async Task<Pagination<VideoDto>> FindByUserId(long userId, long page,
                                                       int size) {
    ...
    return new Pagination<VideoDto>() { Items = videoDtos,
                                        NextPage = videoDtos.Count == size
                                                       ? videoDtos[^1].Id
                                                       : null };
  }
  ...
  public async Task<IReadOnlyList<VideoDto>> VotedVideos(long userId, long page,
                                                         int size) {
...
public static class DomainServiceExtensions {
  ...
  AddDomainService(this IServiceCollection services) =>
